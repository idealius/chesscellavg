...
def render_counts(screen, total_positions_seen, total_threatened_positions, total_threat_positions, display_mode):
    ...
    render_text(screen, "T=Toggle Positions, Threatening,", (square_size * 8 + 5, screen_height - 180), WHITE, 12)
    render_text(screen, "Threatened by opponent", (square_size * 8 + 5, screen_height - 150), WHITE, 12)
